import {Avatar, Group, Menu, ScrollArea, Text, UnstyledButton,} from "@mantine/core";
...
const mockdata = [
    ...
    {
        label: "Demo", icon: TbTheater, initialOpened: true, links: [
            {label: "Customers", link: "/customers"},
            {label: "Netflix Client Showcase", link: "/netflix-client"},
            {label: "Netflix Server Showcase", link: "/netflix-server"},
        ]
    },
    {
        label: "Market news",
