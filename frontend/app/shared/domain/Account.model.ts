...
export const updateAccount = createAccount.required({
    uuid: true
}).partial({
    name: true,
    preferences: true,
...
export type CreateAccount = z.input<typeof createAccount> & { tokens?: OAuth2Tokens };
export type UpdateAccount = z.infer<typeof updateAccount> & { tokens?: OAuth2Tokens };
